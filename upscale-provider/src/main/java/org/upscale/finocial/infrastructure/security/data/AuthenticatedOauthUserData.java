...
public class AuthenticatedOauthUserData {
    ...
    public AuthenticatedOauthUserData(final String username,final String firstname, final Collection<String> permissions) {
    ...
    public AuthenticatedOauthUserData(final String username, final String firstname,final Long officeId, final String officeName, final Long staffId,
    ...
    public AuthenticatedOauthUserData(final String username,final String firstname, final Long userId, final String accessToken) {
        this.username = username;
        this.firstname = firstname;
        this.officeId = null;
        this.officeName = null;
