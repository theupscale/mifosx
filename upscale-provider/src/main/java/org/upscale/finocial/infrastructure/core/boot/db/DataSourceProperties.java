 ...
 * under the License.
 */
package org.upscale.finocial.infrastructure.core.boot.db;
...
public class DataSourceProperties extends PoolProperties {
    ...
    public final static String PORT = "finocial.datasource.port";
    public final static String HOST = "finocial.datasource.host";
    public final static String DB = "finocial.datasource.db";
    public final static String UID = "finocial.datasource.username";
    public final static String PWD = "finocial.datasource.password";
    public final static String PROTOCOL = "finocial.datasource.protocol";
    public final static String SUBPROTOCOL = "finocial.datasource.subprotocol";
    ...
    @Value("${" + DB + ":upscalefinocial-tenants}")
