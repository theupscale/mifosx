...
public class UserDetailsApiResource {
    ...
    public String fetchAuthenticatedUserData(@QueryParam("access_token") final String accessToken) {
        ...
        if (authentication.isAuthenticated()) {
            ...
            AuthenticatedOauthUserData authenticatedUserData = new AuthenticatedOauthUserData(principal.getUsername(),principal.getFirstname(), permissions);
            ...
            if (this.springSecurityPlatformSecurityContext.doesPasswordHasToBeRenewed(principal)) {
                authenticatedUserData = new AuthenticatedOauthUserData(principal.getUsername(), principal.getFirstname(),principal.getId(), accessToken);
            } else {

                authenticatedUserData = new AuthenticatedOauthUserData(principal.getUsername(),principal.getFirstname(), officeId, officeName, staffId, staffDisplayName,
