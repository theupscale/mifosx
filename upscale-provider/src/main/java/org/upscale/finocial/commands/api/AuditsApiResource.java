...
import org.upscale.finocial.commands.service.AuditReadPlatformService;
import org.upscale.finocial.infrastructure.core.api.ApiParameterHelper;
import org.upscale.finocial.infrastructure.core.api.ApiRequestParameterHelper;
import org.upscale.finocial.infrastructure.core.data.PaginationParameters;
import org.upscale.finocial.infrastructure.core.serialization.ApiRequestJsonSerializationSettings;
import org.upscale.finocial.infrastructure.core.serialization.DefaultToApiJsonSerializer;
...
public class AuditsApiResource {
    ...
    public String retrieveAuditEntries(@Context final UriInfo uriInfo, @QueryParam("actionName") final String actionName,
        ...
        if (parameters.isPaged()) {
            ...
            return this.toApiJsonSerializer.serialize(settings, auditEntries, AuditApiConstant.RESPONSE_DATA_PARAMETERS);
        }
    ...
    public String retrieveAuditEntry(@PathParam("auditId") final Long auditId, @Context final UriInfo uriInfo) {
        ...
        final ApiRequestJsonSerializationSettings settings = this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
        return this.toApiJsonSerializer.serialize(settings, auditEntry, AuditApiConstant.RESPONSE_DATA_PARAMETERS);
    }
    ...
    public String retrieveAuditSearchTemplate(@Context final UriInfo uriInfo) {
        ...
        return this.toApiJsonSerializerSearchTemplate.serialize(settings, auditSearchData, AuditApiConstant.RESPONSE_DATA_PARAMETERS_SEARCH_TEMPLATE);
    }
