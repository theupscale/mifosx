...
import org.upscale.finocial.commands.service.PortfolioCommandSourceWritePlatformService;
...
import org.upscale.finocial.infrastructure.core.data.CommandProcessingResult;
import org.upscale.finocial.infrastructure.core.exception.UnrecognizedQueryParamException;
...
public class MakercheckersApiResource {
    ...
    public String retrieveCommands(@Context final UriInfo uriInfo, @QueryParam("actionName") final String actionName,
        ...
        return this.toApiJsonSerializerAudit.serialize(settings, entries, AuditApiConstant.RESPONSE_DATA_PARAMETERS);
    }
